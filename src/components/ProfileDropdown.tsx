...
const ProfileDropdown = forwardRef<HTMLDivElement, ProfileDropdownProps>(
  ({ isSignedIn, onClose, refetch, user }, ref) => {
    ...
    return (
      <div
        ref={ref}
        role="menu"
        className="absolute right-0 top-[48px] z-999 w-[288px] origin-top-right"
      >
        {/* Solid “sidebar-like” shell */}
          ...
          <div className="px-4 py-4 border-b border-white/10">
            <div className="flex flex-col gap-1 min-w-0">
              ...
              <div className="text-white/60 text-xs leading-tight truncate">
                {user.email ??
                  (isSignedIn ? "" : "Use your account to continue")}
              </div>
            </div>
          </div>
