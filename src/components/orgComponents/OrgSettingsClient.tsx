...
import OrgCreateEventSettingsHero from "./OrgCreateEventSettingsHero";
...

    {
      ...
      render: () => (
        <React.Fragment key="members-section">
          <AddOrgMemberSection orgId={org.id} joinRequests={joinRequestsData} />
      ...
      render: () => (
        <React.Fragment key="sponsors-section">
          ...
          <InitialOrgSponsorsSection
            initialSponsors={org.sponsors as unknown as PublicOrgSponsorLink[]}
            orgId={org.id}
            sponsorLibrary={sponsorsData}
          />
        </React.Fragment>
...

    {
      ...
      render: () => (
        <React.Fragment key="events-section">
          <OrgCreateEventSettingsHero orgSlug={orgSlug} />
